...
class TestLevel(unittest.TestCase):
    ...
    def test_coin_collection_success(self):
        ...
        self.assertEqual(self.level.sprites.player.coins, 1)

    def test_no_coins_collected(self):
        self.level.coin_collision()
        self.assertEqual(self.level.sprites.player.coins, 0)

    def test_artifact_collection_success(self):
        player = self.level.sprites.player_cell.sprite
        player.rect.x -= 128
        self.level.artifact_collision()
        self.assertEqual(self.level.sprites.player.artifacts, 1)

    def test_no_artifacts_collected(self):
        self.level.artifact_collision()
        self.assertEqual(self.level.sprites.player.artifacts, 0)
